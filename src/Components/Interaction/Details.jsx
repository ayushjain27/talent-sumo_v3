          ...
          <div className="modal-content">
            <div className='modal-header d-flex justify-content-between'>
              ...
              <div className='d-flex gap-2'>
                <button onClick={handleClone} className='btn btn-outline-dark button'>Clone</button>
                <button onClick={handleEdit} className='btn btn-warning button'>Edit Details</button>
              </div>
            </div>
                    ...
                    <div className="card-body">
                      <form>
                        ...
                        <div className="d-flex justify-content-between mb-3">
                          ...
                          <button disabled={disableButton} type="button" className="btn btn-warning button" data-bs-toggle="modal" data-bs-target="#exampleModal">Add</button>
                        </div>
                      </form>
                      <hr />
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            <div className='modal-header d-flex justify-content-between'>
              ...
              <button onClick={() => setDisableButton(!disableButton)} className='btn btn-warning'>Edit Details</button>
            </div>
            <div className={`${styles.modal} modal-body`}>
              <div className='container'>
                <div className='d-grid col-md-12 mx-auto'>
                  <div className='card border-warning'>
                    <h3 className={`${styles.cardHeader} text-center mb-4 card-header bg-warning`}>Access Details</h3>
                    <div className="card-body">
                      <form>
                        <div className="row">
                          <div className="col-md-6">
                        ...
                        <div className="row">
                          <div className="col-md-4">
                            <div className="mb-3">                                   <label htmlFor="channel" className="form-label fw-bold">Channel</label>                                   <div className="form-check">                                     <input disabled className="form-check-input" type="checkbox" id="telegram" />                                     <label className="form-check-label" htmlFor="telegram">
                              <FaTelegram className='me-1' style={{ color: '#0088cc' }} />Telegram                                     </label>                                   </div>                                   <div className="form-check">
              ...
              <div className="container mt-5 mb-4">
                <div className="row">
                  ...
                  <div className='col-md-7 m-auto'>
                    <div className={`${styles.right} card h-100`} style={{ borderColor: "#fff3cd" }}>
